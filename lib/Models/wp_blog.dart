...
WpBlog wpBlogFromJson(String str) => WpBlog.fromJson(json.decode(str));

String wpBlogToJson(WpBlog data) => json.encode(data.toJson());
...
class WpBlog {
  ...
  factory WpBlog.fromJson(Map<String, dynamic> json) => WpBlog(
